<script>
	...
	onMount(() => {
		...
		// Note: DrawSVGPlugin is a premium plugin, so we'll skip it for now
...
function loadModel()
{
  // Remove DrawSVGPlugin usage since it's premium
...
function setupAnimation(model)
{
  ...
  // Remove DrawSVGPlugin animations since it's premium
  // gsap.to('#line-length', {
  //   drawSVG: 100,
  //   scrollTrigger: {
  //     trigger: ".length",
...
<style>
	/* Paste the contents of your CSS file here, and prefix with `.animated-plane` */
